...
```
carefully convert the “sex”, “ChestPainType”, “RestingECG”, “ExerciseAngina”, “ST_Slope”, and
...
Now that we have the split data, let's build a classification tree. Here we use tidymodels to manage the model building.  
```{r}
